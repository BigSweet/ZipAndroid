...
public class ZipHttpLoggingInterceptor implements Interceptor {
    ...
    public interface Logger {
        ...
        Logger DEFAULT = new Logger() {
            ...
            public void log(String message) {
                printJson("okhttp", message);
//                com.orhanobut.logger.Logger.d(message != null ? message : "null");
//                Log.i("OkHttp", message != null ? message : "null");
//                Platform.get().log(INFO, message, null);
    ...
    public static void printLog(@NonNull String tag, @Nullable String message) {
        // 这里解释一下，为什么不用 Log.d，而用 Log.i，因为 Log.d 在魅族 16th 手机上面无法输出日志
        Log.i(tag, message != null ? message : "null");
    }

    public ZipHttpLoggingInterceptor() {
        this(Logger.DEFAULT);
    }

    public ZipHttpLoggingInterceptor(Logger logger) {
        this.logger = logger;
    }
     ...
     */
    public ZipHttpLoggingInterceptor setLevel(Level level) {
...
//            logger.log("WSM-Content " + bodyToString(request));
