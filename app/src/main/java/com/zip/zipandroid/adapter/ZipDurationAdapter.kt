...
class ZipDurationAdapter : BaseQuickAdapter<ProductDidInfo, BaseViewHolder>(R.layout.item_install_zip) {
    var selectPosition = 0
    override fun convert(holder: BaseViewHolder, item: ProductDidInfo) {
        ...
        item_install_tv.setText(item.intervalStart.toString())
