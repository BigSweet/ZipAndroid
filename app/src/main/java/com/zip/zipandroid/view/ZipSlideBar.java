 ...
 */
public class ZipSlideBar extends View {
    ...
    public ZipSlideBar(Context context) {
        super(context);
        init(context, null);
    }

    public ZipSlideBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ZipSlideBar(Context context, AttributeSet attrs, int defStyleAttr) {
